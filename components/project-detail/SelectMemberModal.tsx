...
const SelectMemberModal: React.FC<SelectMemberModalProps> = ({
  ...
  const filteredBySearch = listToRender.filter(
    (p) =>
  ...
  const groupedMembers = filteredByDepartment.reduce(
    (acc, member) => {
    ...
    <>
      <div className="flex items-center gap-4">
        ...
        {/* <button
          ...
          className="px-4 py-2 bg-indigo-600 text-white rounded-xl md:rounded-2xl shadow-sm hover:shadow-lg hover:bg-indigo-700 transition-all duration-300 active:scale-95 text-[11px] md:text-xs font-medium shrink-0"
        >
